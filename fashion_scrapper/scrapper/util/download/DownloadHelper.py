...
###    def __init__(self, brand_path, **args):
...
###    @staticmethod
###    def instantiate_mango(**args):
###        category_path = args.get("category_path")
###        brand_path = MangoPaths(category_path)
###        return DownloadHelper(brand_path=brand_path, **args)

###    @staticmethod
###    def instantiate_masos(**args):
###        category_path = args.get("category_path")
###        brand_path = AsosPaths(category_path)
###        return DownloadHelper(brand_path=brand_path, **args)
